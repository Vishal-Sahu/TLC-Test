...
class CustomerListReport extends TaskExecutable {
    ...
    def execute() {
        ...
        reportParams.colCode = message(code: 'customer.code.label', default: 'Code')
        reportParams.colName = message(code: 'customer.name.label', default: 'Name')
        ...
        def title = utilService.standardMessage('list', 'customer')
