    ...
    <g:form method="post">
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    <td class="name">
                        <label for="id"><g:msg code="systemPaymentSchedule.test.schedule.label" default="Payment Schedule"/></label>
                    </td>
                    <td class="value ${hasErrors(bean: systemPaymentScheduleInstance, field: 'id', 'errors')}">
                        <g:domainSelect autofocus="autofocus" name="id" options="${scheduleList}" selected="${systemPaymentScheduleInstance?.id}" prefix="paymentSchedule.name" code="code" default="name"/>&nbsp;<g:help code="systemPaymentSchedule.test.schedule"/>
                    </td>
                </tr>
