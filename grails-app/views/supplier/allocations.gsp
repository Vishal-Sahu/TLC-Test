            ...
            <table>
                ...
                <g:if test="${lineInstance.id}">
                    <tr class="prop">
                        ...
                        <td class="value"><g:enquiryLink target="${lineInstance.supplier}" displayPeriod="${lineInstance.document.period}" displayCurrency="${displayCurrency}">${lineInstance.supplier.code.encodeAsHTML()}</g:enquiryLink></td>

                        <td class="name"><g:msg code="supplier.name.label" default="Name"/></td>
                        <td class="value nowrap">${lineInstance.supplier.name.encodeAsHTML()}</td>

                        <td class="name"><g:msg code="generic.accountCurrency" default="Account Currency"/></td>
                        <td class="value">${msg(code: 'currency.name.' + lineInstance.supplier.currency.code, default: lineInstance.supplier.currency.name)}</td>
                    </tr>
                </g:if>
                </tbody>
            </table>
