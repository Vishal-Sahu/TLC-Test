...
<div class="dialog">
    <table>
        ...
        <tr class="prop">
            <td class="name">
                <g:msg code="task.Company.label" default="Company"/>:
            </td>
            <td class="value">
        ...
        <tr class="prop">
            <td class="name">
                <label for="user"><g:msg code="queuedTask.user.label" default="User"/></label>
            </td>
            <td class="value ${hasErrors(bean: queuedTaskInstance, field: 'user', 'errors')}">
                <g:select autofocus="autofocus" optionKey="id" optionValue="name" from="${companyUserList}" name="user.id" value="${queuedTaskInstance?.user?.id}"/>&nbsp;<g:help code="queuedTask.user"/>
            </td>
        </tr>
