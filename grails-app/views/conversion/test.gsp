            ...
            <table>
                ...
                <tr class="prop">
                    ...
                    <td class="value ${hasErrors(bean: testInstance, field: 'fromUnit', 'errors')}">
                        <g:domainSelect autofocus="autofocus" name="fromUnit.id" options="${unitList}" selected="${testInstance?.fromUnit}" prefix="unit.name" code="code" default="name"/>&nbsp;<g:help code="conversionTest.fromUnit"/>
                    </td>
                </tr>
