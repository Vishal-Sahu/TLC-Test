            ...
            <table>
                ...
                <g:if test="${documentInstance.id}">
                    <tr class="prop">
                        ...
                        <td class="value" colspan="3"><g:enquiryLink target="${supplierInstance}" displayPeriod="${documentInstance.period}" displayCurrency="${displayCurrency}">${supplierInstance.code.encodeAsHTML()}</g:enquiryLink>&nbsp;${supplierInstance.name.encodeAsHTML()}</td>
                    ...
                    <tr class="prop">
                        ...
                        <td class="name"><g:msg code="document.supplier.reference.label" default="Reference"/></td>
                    ...
                    <tr class="prop">
                        ...
                        <td class="name"><g:msg code="generalTransaction.accountUnallocated.label" default="Unallocated"/></td>
                        <td class="value nowrap"><g:enquiryLink target="${totalInstance}" displayPeriod="${displayPeriod}" displayCurrency="${displayCurrency}"><g:drcr context="${documentInstance}" line="${totalInstance}" field="unallocated" currency="${displayCurrency}" zeroIsUnmarked="true"/></g:enquiryLink></td>
                    </tr>
                </g:if>
                </tbody>
            </table>
