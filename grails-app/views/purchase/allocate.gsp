        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    ...
                    <td class="value nowrap" colspan="3">${display(bean: supplierInstance, field: 'name')}</td>

                    <td class="name"><g:msg code="document.currency.label" default="Currency"/></td>
                    <td class="value" colspan="2">${msg(code: 'currency.name.' + supplierInstance.currency.code, default: supplierInstance.currency.name)}</td>
                </tr>
                </tbody>
            </table>
