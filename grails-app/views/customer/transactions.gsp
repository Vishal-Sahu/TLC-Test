        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    ...
                    <td class="value nowrap">${display(bean: customerInstance, field: 'name')}</td>
                ...
                <tr>
                    <td class="name nowrap"><g:msg code="customer.accountCurrentBalance.label" default="Current Balance"/></td>
                    <td class="value"><g:cr context="${customerInstance}" field="balance"/></td>

                    <td class="name"><g:msg code="customer.currency.label" default="Currency"/></td>
                    <td class="value nowrap">${msg(code: 'currency.name.' + customerInstance.currency.code, default: customerInstance.currency.name)}</td>
