...
<html>
<head>
    <title><g:msg code="customer.statements.label" default="Customer Statements"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="customer.statements.label" default="Customer Statements"/>
        ...
        <g:form action="statement" method="post">
            <div class="dialog">
                <table>
                    ...
                    <tr class="prop">
                        <td class="name">
                            <label for="taxId"><g:msg code="customer.statement.customer.label" default="Specific Customer"/></label>
                        </td>
                    ...
                    <tr class="prop">
                        <td class="name">
                            <label for="statementDate"><g:msg code="customer.statements.date.label" default="Statement Date"/></label>
                        </td>
