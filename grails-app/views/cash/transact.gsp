    ...
    <g:form method="post">
        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    <td class="name">
                        <label for="sourceCode"><g:msg code="cash.account.label" default="Cash Account"/></label>
                    </td>
                    <td class="vtop small-value ${hasErrors(bean: documentInstance, field: 'sourceCode', 'errors')}">
                        <g:select autofocus="autofocus" onchange="accountChanged()" onblur="getBank(this, '${createLink(controller: 'document', action: 'bank')}', 'cash')" optionKey="code" optionValue="name" from="${bankAccountList}" name="sourceCode" value="${documentInstance?.sourceCode}" noSelection="['': msg(code: 'generic.select', default: '-- select --')]"/>&nbsp;<g:help code="cash.account"/>
                    </td>
        ...
        <div class="list entry">
            <table>
                ...
                <tr>
                    ...
                    <th><g:msg code="document.bank.taxCode.label" default="Tax Code"/>&nbsp;<g:help code="document.bank.taxCode"/></th>
        ...
        <div class="buttons">
            <span class="button"><g:actionSubmit class="save" action="transacting" value="${msg(code:'default.button.create.label', 'default':'Create')}"/></span>
