            ...
            <table>
                ...
                <g:if test="${documentInstance.id}">
                    <tr class="prop">
                        ...
                        <td class="value" colspan="3"><g:enquiryLink target="${customerInstance}" displayPeriod="${documentInstance.period}" displayCurrency="${displayCurrency}">${customerInstance.code.encodeAsHTML()}</g:enquiryLink>&nbsp;${customerInstance.name.encodeAsHTML()}</td>
