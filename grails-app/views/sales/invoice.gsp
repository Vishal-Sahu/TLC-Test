    ...
    <g:form method="post">
        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    <td class="name">
                        <label for="sourceCode"><g:msg code="document.customer.label" default="Customer"/></label>
                    </td>
                    <td class="vtop small-value ${hasErrors(bean: documentInstance, field: 'sourceCode', 'errors')}">
                        <input autofocus="autofocus" onchange="getLedger(this, '${createLink(controller: 'document', action: 'customer')}')" type="text" maxlength="20" size="20" id="sourceCode" name="sourceCode" value="${display(bean: documentInstance, field: 'sourceCode')}"/>&nbsp;<g:help code="document.customer"/>
                    </td>
                ...
                <tr class="prop">
                    <td class="name">
                        <label for="reference"><g:msg code="document.customer.reference.label" default="Reference"/></label>
                    </td>
