...
<div class="dialog">
    <table>
        ...
        <tr class="prop">
            <td class="name">
                <label for="sourceCode"><g:msg code="templateDocument.customer.label" default="Customer"/></label>
            </td>
            <td class="vtop small-value ${hasErrors(bean: templateDocumentInstance, field: 'sourceCode', 'errors')}">
                <input autofocus="autofocus" onchange="getLedger(this, '${createLink(controller: 'document', action: 'customer')}')" type="text" maxlength="20" size="20" id="sourceCode" name="sourceCode" value="${display(bean: templateDocumentInstance, field: 'sourceCode')}"/>&nbsp;<g:help code="templateDocument.customer"/>
            </td>
