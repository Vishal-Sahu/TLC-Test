            ...
            <table>
                ...
                <tr class="prop">
                    ...
                    <td class="value ${hasErrors(bean: balanceReportFormatInstance, field: 'name', 'errors')}">
                        <input autofocus="autofocus" type="text" maxlength="30" size="30" id="name" name="name" value="${display(bean: balanceReportFormatInstance, field: 'name')}"/>&nbsp;<g:help code="balanceReportFormat.name"/>
                    </td>
                </tr>
                </tbody>
            </table>
