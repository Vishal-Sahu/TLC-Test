        ...
        <div class="list entry">
            <table>
                ...
                <tr>
                    ...
                    <th class="nowrap"><g:msg code="document.line.to.label" default="T/O"/>&nbsp;<g:help code="document.line.to"/></th>
                ...
                <g:each in="${documentInstance.lines}" status="i" var="documentLine">
                    ...
                    <tr>
                        <td class="narrow smallBottomPadding" colspan="4"><input disabled="disabled" type="text" size="76" id="lines[${i}].displayName" name="lines[${i}].displayName" value="${display(bean: documentLine, field: 'accountName')}"/></td>
