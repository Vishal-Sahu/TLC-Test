...
<html>
<head>
    <title><g:msg code="create" domain="customerAddress"/></title>
</head>
<body>
<div class="nav" role="navigation">
    <span class="menuButton"><a class="home" href="${createLink(uri: '/')}"><g:msg code="default.home.label" default="Home"/></a></span>
    <span class="menuButton"><g:link class="menu" controller="systemMenu" action="display"><g:msg code="systemMenu.display" default="Menu"/></g:link></span>
    <span class="menuButton"><g:link class="list" controller="customer" action="show" id="${customerAddressInstance.customer.id}"><g:msg code="customerAddress.customer.label" default="Customer"/></g:link></span>
</div>
<div id="main-content" class="body" role="main">
    ...
    <g:form name="jsform" action="initializing" method="post" >
        ...
        <g:render template="form" model="[customerAddressInstance: customerAddressInstance]"/>
        <div class="buttons">
