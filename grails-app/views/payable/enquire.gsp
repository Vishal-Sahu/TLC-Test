            ...
            <table>
                ...
                <g:if test="${documentInstance.id}">
                    <tr class="prop">
                        ...
                        <td class="name" colspan="2"><g:msg code="generalTransaction.affectsTurnover.label" default="Affects Turnover"/>:&nbsp;&nbsp;${display(bean: documentInstance, field: 'sourceAffectsTurnover')}</td>
    ...
    <g:if test="${documentInstance.id}">
        <div class="list">
            <table>
                <thead>
                <tr>
                    <th><g:msg code="document.supplier.label" default="Supplier"/></th>
