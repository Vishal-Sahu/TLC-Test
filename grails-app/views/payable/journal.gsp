    ...
    <g:form method="post">
        ...
        <div class="list entry">
            <table>
                <thead>
                <tr>
                    <th><g:msg code="document.supplier.label" default="Supplier"/>&nbsp;<g:help code="document.supplier"/></th>
                ...
                <g:each in="${documentInstance.lines}" status="i" var="documentLine">
                    ...
                    <tr>
                        <td class="narrow smallBottomPadding" colspan="2"><input disabled="disabled"="true" type="text" size="76" id="lines[${i}].displayName" name="lines[${i}].displayName" value="${display(bean: documentLine, field: 'accountName')}"/></td>
