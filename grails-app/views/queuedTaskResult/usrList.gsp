        ...
        <table>
            ...
            <g:each in="${queuedTaskResultInstanceList}" status="i" var="queuedTaskResultInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td><g:link action="usrShow" id="${queuedTaskResultInstance.id}"><g:msg code="taskResult.name.${queuedTaskResultInstance.queued.task.code}.${queuedTaskResultInstance.result.code}" default="${queuedTaskResultInstance.result.name}"/></g:link></td>
