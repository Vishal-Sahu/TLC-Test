        ...
        <div class="dialog">
            <table>
                ...
                <g:if test="${documentInstance.id}">
                    <tr class="prop">
                        <td class="name"><g:msg code="bank.account.label" default="Bank Account"/></td>
                    ...
                    <tr class="prop">
                        ...
                        <td colspan="3" class="value">${display(bean: documentInstance, field: 'description')}</td>

                        <td class="name"><g:msg code="document.journal.reference.label" default="Reference"/></td>
                        <td colspan="3" class="value">${display(bean: documentInstance, field: 'reference')}</td>
                    </tr>
                </g:if>
                </tbody>
            </table>
        ...
        <div class="list">
            <table>
                ...
                <tr>
                    ...
                    <th class="right"><g:msg code="document.amount.label" default="Value"/></th>
                </tr>
                </thead>
                <tbody>
